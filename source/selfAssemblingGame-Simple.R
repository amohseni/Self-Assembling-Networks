...
for (i in 1:N) { # create N agents
  ...
  reliablity.epistemic.vector[i + 1] <- assign(paste("reliability1", i, sep=""), round(runif(1, reliablity.Nature.inf, reliablity.Nature.sup), digits=3))
  # generate and record a social reliability value in [0,1] -- for learning the correct state from other agents
  reliablity.social.vector[i + 1] <- assign(paste("reliability2", i, sep=""), round(runif(1, reliablity.agents.inf, reliablity.agents.sup), digits=3))
