...
shinyUI(fluidPage(
  ...
  sidebarLayout(
    sidebarPanel(
      ...
      # Instructions text
      p("To explore the model, select the simulation parameters, then click the 'RUN SIMULATION' button."),
    ...
    mainPanel(
      ndtv:::ndtvAnimationWidgetOutput("netPlot", width = "100%", height = "560px")
      )
